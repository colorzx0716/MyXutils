...
import com.bawie.myxutils.adapter.MyAdapter;
import com.bawie.myxutils.bean.Catogray;
import com.bawie.myxutils.sql.DbHelper;
                ...
                if(list != null && list.size() > 0){
                    for (Catogray catogray:list) {
                        if (catogray.state) {//判断是否是选中状态，如果选中则执行下载操作
                            Toast.makeText(LiXianActivity.this, "断是否是选中状态，如果选中则执行下载操作", Toast.LENGTH_SHORT).show();
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(int pos, View view) {
                ...
                if (checkbox.isChecked()) {
                    Toast.makeText(LiXianActivity.this, "我被取消了", Toast.LENGTH_SHORT).show();
                    checkbox.setChecked(false);
                    c.state = false;
                } else {
                    Toast.makeText(LiXianActivity.this, "我被点击了", Toast.LENGTH_SHORT).show();
